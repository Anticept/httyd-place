...
Edit the [toothless_full.png](../blob/main/toothless_full.png) file without changing the pixel dimensions. Then run the [dithering.py](../blob/master/dithering.py) script on the image, PR the output, and get it merged!
